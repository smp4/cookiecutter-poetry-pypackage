...
```
├── AUTHORS.md        <- Authors list. Also linked to by docs.
│                        Requires create_author_file.
├── CHANGELOG.md      <- Record your changes here. Linked to by docs.
├── CONTRIBUTING.md   <- Guide for contributors. Also linked to by docs.
...
│   ├── about         <- About the project. Symbolic links to AUTHORS, CHANGELOG, CONTRIBUTING,
│   │                    LICENSE.
│   ├── advanced      <- Information interesting to advanced users. Not mandatory for basic usage. 
...
│   ├── index.md      <- Starting page of hte docs
│   ├── installation.md <- Links to README.md b default.
│   ├── quickstart.md <- Instructions for a minimal startup.
│   └── tutorials.md  <- Step by step for new users to the project.
...
│                        files.
├── README.md         <- README for developers using this project. Basic installation and usage.
